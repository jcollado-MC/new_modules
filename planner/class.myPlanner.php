...
class myPlanner extends Planner
{
    ...
    function __construct($date_start='', $date_end='')
    {
        ...
        $this -> shops[] = ['order' => '0', 'date' => '2020-05-08','shop_id' => '1553', 'client' => 'Saturn', 'name' => 'Saturn Electro-Handels GmbH', 'street' => '', 'city' =>'Gelsenkirchen',  'cat' => 'Elektrofachm (groß)', 'color' => 'YELLOW','offline' => 'true', 'group1'=>'Saturn', 'group2'=>'Gelsenkirchen', 'group3'=>'Rhein-Ruhr'];
