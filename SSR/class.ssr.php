        ...
        <div class='col-3'>
            ...
            $code .="
                    <div class='col-12 table-fields' >
                        ...
                        <div class='title-part'>
                            ...
                            <h5 class='col-10'>Base</h5>
                            <div class='col-2 row'>
                                <label class='switch'>
                                    <input type='checkbox' id='group1' class='groups'>
            ...
            $code .="<div class='col-12 table-fields'>
                        ...
                        <div class='title-part'>
                            ...
                            <div class='col-2 row'>
                                <label class='switch'>
                                    <input type='checkbox' id='group2' class='groups'>
                                    <span class='slider round'></span>
                                </label>
                            </div>
            ...
            $code .="<div class='col-12  table-fields'>
                        ...
                        <div class='title-part'>
                            ...
                            <div class='col-2 row '>
                                <label class='switch'>
                                    <input type='checkbox' id='group3' class='groups'>
                                    <span class='slider round'></span>
                                </label>
                            </div>
